...
<form action="<?php echo $_SERVER["REQUEST_URI"]?>" method="post">
    ...
    <input style="width:100%" id="cs_title" type="text" name="title" placeholder="put your title here" required/><br/><br/>

    <label for="cs_description">Description<abbr class="required" title="required"> *</abbr></label>
    <textarea id="cs_description" name="description" placeholder="put your description here" required></textarea><br/><br/>
    <input type="submit">
</form>